                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="post" action="update_profile_user.php" enctype="multipart/form-data">
                                    ...
                                    ?>
                                    <div class="form-group">
                                        <label class="col-sm-12">Pilih Keterangan</label>
                                        <div class="col-sm-12">
                                            <select name="keterangan" class="form-control form-control-line">
                                                <option>Pilih Keterangan</option>
                                                <option>Lulus verifikasi</option>
                                                <option>Tidak lulus verifikasi</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="catatan" value="<?php echo $d['catatan'];?>" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
